...
class BalanceSheetController(http.Controller):
    ...
    def _render_page(self, wizard_id, date_to, date_from,
        ...
        css_url  = f'/bak_balance_sheet_report/static/src/css/balance_sheet.css?v={v}'
        js_url   = f'/bak_balance_sheet_report/static/src/js/balance_sheet_action.js?v={v}'
        # Owl (Odoo Web Library) runtime — bundled with the 'web' module, always
        # available regardless of whether Accounting/other apps are installed.
        owl_url  = f'/web/static/lib/owl/owl.js?v={v}'
        dc_val   = 'true' if display_debit_credit else 'false'
...
<div id="bak_bs_app"
    ...
    <div class="bak-bs-topbar">
        ...
        <div class="bak-bs-topbar-right">
            ...
            <button class="bak-btn bak-btn-outline" id="btn_xlsx">&#128202; XLSX</button>
            <button class="bak-btn bak-btn-outline" id="btn_comparison">&#8646; Comparison</button>
            <button class="bak-btn bak-btn-outline" id="btn_split" title="Show Assets and Liabilities/Equity side by side">&#9707; Split Horizontally</button>
            <select class="bak-select" id="sel_moves">
                <option value="posted">Posted Entries</option>
                <option value="all">All Entries</option>
            </select>

...
class BalanceSheetInlineReport(models.TransientModel):
    ...
    CREDIT_NORMAL_TYPES = {
        ...
        'equity',
        'equity_unaffected',
        # FIX: current_year_earnings also has a CREDIT normal balance.
        # Must be flipped so Net Profit shows as a positive equity figure.
    ...
    def _get_account_groups(self):
        ...
        SECTION_MAP = {
            ...
            'equity_unaffected':      ('equity',      'Unallocated Earnings'),
            'equity':                 ('equity',      'Retained Earnings'),
            # FIX: Odoo 19 CE uses 'current_year_earnings' for Undistributed
            # Profits/Losses account.  Without this entry the account was
            # silently skipped, causing Assets ≠ Liabilities + Equity.

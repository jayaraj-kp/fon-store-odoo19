...
class PosSpecialOffer(models.Model):
    ...
    warehouse_ids = fields.Many2many(
        ...
        string='Restrict to Warehouses',
        help='Leave empty to apply in ALL warehouses. '
             'If one or more warehouses are selected, this offer will only '
             'be visible and applicable in POS sessions that belong to those warehouses.')

...
class PurchaseOrder(models.Model):
    ...
    def default_get(self, fields_list):
        """
        Override default_get to set picking_type_id (Deliver To) from the
        user's default warehouse instead of Odoo's company-level default.
        """
        ...
        if wh and wh.in_type_id:
            ...
            _logger.debug(
                'default_get: set picking_type_id to %s (warehouse: %s)',
                wh.in_type_id.name, wh.name,
            )
        return res

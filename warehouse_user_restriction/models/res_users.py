...
#     )
#
#     disallowed_product_category_ids = fields.Many2many(
#         'product.category',
#         'res_users_disallowed_product_category_rel',
#         'user_id',
#         'category_id',
#         string='Disallowed Product Categories',
#     )
#
#     @property
...
#             'disallowed_product_category_ids',
#         ]
#
#     @api.model
...
class ResUsers(models.Model):
    ...
    @api.model
    def _load_pos_data_fields(self, config):
        # Return only safe fields needed by POS frontend.
        # Avoids exposing warehouse/restriction fields to browser.
        # Return value is IDENTICAL to original — only removed verbose logging.

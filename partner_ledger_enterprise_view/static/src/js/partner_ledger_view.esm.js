...
//            // Reuse the account row's indentation/typography, plus its own
//            // class for the italic treatment below.
//            classes.push("pl-account-row", "pl-initial-row");
//        }
//        return classes.join(" ");
//    }
//
...
export class PartnerLedgerView extends Component {
    ...
    setup() {
        ...
        this.state = useState({
            ...
            // Lazy-load control: the report body stays on a placeholder
            // screen (pick partners / "Load All Partners") until data has
            // actually been requested at least once. This avoids the
            // heavy default query firing automatically on every open when
            // the ledger holds a large number of partners/entries.
            dataLoaded: false,
        ...
        onWillStart(async () => {
            ...
            // partner/tag/analytic scope already applied (e.g. drilling in
            // from a partner's form view) — that's a small, targeted
            // query. A plain fresh open of the report waits for the user
            // to pick partners or press "Load All Partners" below, since
            // querying every partner by default is what causes the lag on
            // large databases.
            if (

...
/* =========================================================
   ✅ PATCH POS ORDER (MAIN FIX)
   Add charity donation into TOTAL
========================================================= */
...
patch(PosOrder.prototype, {
    ...
    // 🔥 CORE FIX: Add donation into total
    get_total_with_tax() {
        const baseTotal = super.get_total_with_tax(...arguments);
        const donation = this._charity_donation_amount || 0;
        return baseTotal + donation;
    },

    // 🔥 ALSO REQUIRED for Odoo 19 reactive UI
    get amount_total() {
        const base = super.amount_total;
        const donation = this._charity_donation_amount || 0;
